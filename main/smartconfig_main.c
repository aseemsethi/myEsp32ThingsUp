                                ...
                                int32_t event_id, void* event_data)
{
    if (event_base == SC_EVENT && event_id == SC_EVENT_SCAN_DONE) {
        ...
        oledClear(); oledDisplay(7, 10, "SC Connected:"); oledDisplay(7, 25, (char*)evt->ssid);
...
void smartconfig_run_task(void * parm)
{
    EventBits_t uxBits;
